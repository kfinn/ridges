...
const NewProps = struct {
    ...
    user_errors: ?ridges_lib.validation.RecordErrors(User.Repo.NewRecord) = null,
    password_confirmation_errors: ?ridges_lib.validation.RecordErrors(PasswordConfirmation) = null,
};
